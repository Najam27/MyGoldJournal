...
describe("Mt5LiveView", () => {
  it("shows masked credentials, account metrics, historical positions, EA v1.12, and automatic Trade Log synchronization", () => {
    ...
    expect(ea.getAttribute("href")).toContain("GoldJournal_EA_a3b87ed8.mq5");
